...
#List of symptoms that the patient may have
...
# STORING THE TRAINING DATA FROM csv FILE
...
# STORING THE TESTING DATA FROM csv FILE
tr=pd.read_csv("Testing.csv")

#CONVERTING THE DISEASE TO A NUMBER
...
w2 = Label(root, justify=LEFT, text="A Group Project by Amit, Sushen and Himanshu", fg="white", bg="blue")
w2.config(font=("Aharoni", 30))
w2.grid(row=2, column=0, columnspan=2, padx=100)

# labels
NameLb = Label(root, text="Name of the Patient", fg="yellow", bg="black")
NameLb.grid(row=6, column=0, pady=40, sticky=W)
